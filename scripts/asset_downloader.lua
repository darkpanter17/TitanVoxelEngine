...
-- Fallback a dummyimage porque la URL original (Fogleman Craft) está caída
local base = "https://dummyimage.com/16x16/"
local textures = {
    { name = "dirt",  url = base .. "8B4513/fff.png&text=dirt" },
    { name = "grass", url = base .. "228B22/fff.png&text=grass" },
    { name = "stone", url = base .. "808080/fff.png&text=stone" },
    { name = "sand",  url = base .. "F4A460/fff.png&text=sand" },
    { name = "wood",  url = base .. "A0522D/fff.png&text=wood" }
}
