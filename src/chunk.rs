...
mod tests {
    ...
    fn test_chunk_set_get() {
        ...
        chunk.set_voxel(10, 10, 10, 5);
        assert_eq!(chunk.get_voxel(10, 10, 10), 5);
    ...
    fn test_chunk_bounds() {
        let mut chunk = Chunk::new(IVec3::ZERO);
        chunk.set_voxel(100, 100, 100, 5); // Should not panic or set
        assert_eq!(chunk.get_voxel(100, 100, 100), 0);
    }
}