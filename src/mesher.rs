...
mod tests {
    ...
    fn test_meshing_single_voxel() {
        ...
        // A single voxel in air should have 6 faces.
        // Each face is a quad (4 vertices, 6 indices).
    ...
    fn test_meshing_culling() {
        ...
        // Each voxel has 6 faces initially.
        // They share 1 face (Right of first, Left of second).
        // These shared faces should be culled.
        // So each voxel should show 5 faces.
        // Total faces = 10.
        // Vertices = 10 * 4 = 40.
        // Indices = 10 * 6 = 60.
