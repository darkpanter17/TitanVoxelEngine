    ...
    for y in 0..CHUNK_HEIGHT {
        for z in 0..CHUNK_SIZE {
            for x in 0..CHUNK_SIZE {
                ...
                let layer = (voxel - 1) as u32; // Map Block ID to layer (e.g. 1 -> 0)
                let xf = x as f32 + (chunk.position.x * CHUNK_SIZE as i32) as f32;
                let yf = y as f32 + (chunk.position.y * CHUNK_HEIGHT as i32) as f32;
                let zf = z as f32 + (chunk.position.z * CHUNK_SIZE as i32) as f32;
