...
fn push_face(verts: &mut Vec<Vertex>, inds: &mut Vec<u32>, count: &mut u32,
    ...
    verts.push(Vertex { pos: v0, uv: [0.0, 0.0], layer });
    verts.push(Vertex { pos: v1, uv: [0.0, 1.0], layer });
    verts.push(Vertex { pos: v2, uv: [1.0, 1.0], layer });
    verts.push(Vertex { pos: v3, uv: [1.0, 0.0], layer });
