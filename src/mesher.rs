            ...
            for y in 0..crate::chunk::CHUNK_HEIGHT {
                ...
                if id != 0 {
                    ...
                    if x == 0 || chunk.get_voxel(x - 1, y, z) == 0 {
                        verts(&mut vertices, &mut indices, &mut index_count,
                    ...
                    // Cara Arriba (+Y)
                    if y == crate::chunk::CHUNK_HEIGHT - 1 || chunk.get_voxel(x, y + 1, z) == 0 {
                        verts(&mut vertices, &mut indices, &mut index_count,
...
fn verts(verts: &mut Vec<Vertex>, inds: &mut Vec<u32>, count: &mut u32,
