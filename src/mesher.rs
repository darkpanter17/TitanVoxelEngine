...
pub fn generate_mesh(chunk: &Chunk) -> Mesh {
    ...
    let chunk_y = (chunk.position.y * CHUNK_HEIGHT as i32) as f32; // position.y is 0
    ...
    for x in 0..CHUNK_SIZE {
        for z in 0..CHUNK_SIZE {
            for y in 0..CHUNK_HEIGHT {
                 ...
                 if voxel != 0 {
                    let layer = voxel as u32 - 1; // Assuming layer 0 is texture 1
                    let xf = x as f32 + chunk_x;
                    let yf = y as f32 + chunk_y;
                    let zf = z as f32 + chunk_z;
