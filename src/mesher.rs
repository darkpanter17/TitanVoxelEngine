...
pub fn generate_mesh(chunk: &Chunk) -> Mesh {
    ...
    let pos_x = (chunk.position.x * CHUNK_SIZE as i32) as f32;
    let pos_z = (chunk.position.z * CHUNK_SIZE as i32) as f32;
    ...
    for x in 0..CHUNK_SIZE {
        for z in 0..CHUNK_SIZE {
            for y in 0..CHUNK_HEIGHT {
                ...
                if voxel_id != 0 {
                    let layer = voxel_id as u32 - 1; // Voxel ID to texture layer mapping
                    let xf = pos_x + x as f32;
                    let yf = y as f32;
                    let zf = pos_z + z as f32;
