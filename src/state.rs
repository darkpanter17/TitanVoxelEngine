        ...
        chunks.par_iter_mut().for_each(|chunk| {
            for x in 0..crate::chunk::CHUNK_SIZE {
                for z in 0..crate::chunk::CHUNK_SIZE {
                    ...
                    // Simple sine wave height map
                    let height = 10 + ((world_x * 0.1).sin() * 5.0 + (world_z * 0.1).cos() * 5.0) as i32;
                    let max_y = height.clamp(0, crate::chunk::CHUNK_HEIGHT as i32 - 1) as usize;
