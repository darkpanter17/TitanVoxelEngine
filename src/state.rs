...
impl<'a> State<'a> {
    pub async fn new(window: &'a Window) -> Self {
        ...
        chunks.par_iter_mut().for_each(|chunk| {
            let cx_offset = (chunk.position.x * crate::chunk::CHUNK_SIZE as i32) as f32;
            let cz_offset = (chunk.position.z * crate::chunk::CHUNK_SIZE as i32) as f32;
            ...
            for x in 0..crate::chunk::CHUNK_SIZE {
                for z in 0..crate::chunk::CHUNK_SIZE {
                    ...
                    let height = (10.0 + (world_x / 10.0).sin() * 5.0 + (world_z / 10.0).cos() * 5.0) as usize;
